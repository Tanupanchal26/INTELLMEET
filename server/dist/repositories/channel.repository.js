...
class ChannelRepository extends BaseRepository {
    ...
    async addMember(channelId, userId) {
        return Channel.findByIdAndUpdate(channelId, { $addToSet: { members: userId } }, { new: true });
    }
    async removeMember(channelId, userId) {
        return Channel.findByIdAndUpdate(channelId, { $pull: { members: userId } }, { new: true });
    }
    async pinMessage(channelId, messageId) {
        return Channel.findByIdAndUpdate(channelId, { $addToSet: { pinnedMessages: messageId } }, { new: true });
    }
    async unpinMessage(channelId, messageId) {
        return Channel.findByIdAndUpdate(channelId, { $pull: { pinnedMessages: messageId } }, { new: true });
    }
