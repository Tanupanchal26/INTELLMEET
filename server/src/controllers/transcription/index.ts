 ...
 */
exports.transcribeAudio = asyncHandler(async (req: any, res: any) => {
  ...
  if (!text) return ApiResponse.ok(res, { text: '', segments: [] }, 'No speech detected');
 ...
 */
exports.consolidateTranscript = asyncHandler(async (req: any, res: any) => {
  const { meetingId } = req.params;
