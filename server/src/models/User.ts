...
import { ROLES, USER_STATUS, AUTH } from '../constants';

const ROLE_VALUES   = Object.values(ROLES) as string[];
const STATUS_VALUES = Object.values(USER_STATUS) as string[];
...
userSchema.pre('save', async function (next) {
  ...
  this.password = await bcrypt.hash(this.password as string, AUTH.BCRYPT_ROUNDS);
...
userSchema.methods.createToken = function (type: 'emailVerify' | 'passwordReset'): string {
